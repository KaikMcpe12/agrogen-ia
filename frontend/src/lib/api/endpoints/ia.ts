...
export const iaApi = {
  ...
  padroes: (params?: { fazenda_id?: string; data_inicio?: string; data_fim?: string; especie?: Especie }) =>
    client.get<ApiResponse<PadroesFertilidade>>("/ia/padroes-fertilidade", { params }).then((r) => r.data),
